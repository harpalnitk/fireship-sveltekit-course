import{d as ld,w as ni}from"./index.31c0fd71.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd="storage";function _E(t,e,n){return t=$(t),z_(t,e,n)}function EE(t){return t=$(t),H_(t)}function IE(t,e){return t=$(t),Q_(t,e)}function X_(t=Fi(),e){t=$(t);const s=Zs(t,cd).getImmediate({identifier:e}),r=Mc("storage");return r&&J_(s,...r),s}function J_(t,e,n,s={}){Y_(t,e,n,s)}function Z_(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new na(n,s,r,e,bt)}function eE(){_t(new et(cd,Z_,"PUBLIC").setMultipleInstances(!0)),ke(Rc,Nc,""),ke(Rc,Nc,"esm2017")}eE();const tE={apiKey:"AIzaSyA4hIw9uAbEaMJ5hxrdxN32jaGwX3SC-dY",authDomain:"sveltekit1-0.firebaseapp.com",databaseURL:"https://sveltekit1-0-default-rtdb.firebaseio.com",projectId:"sveltekit1-0",storageBucket:"sveltekit1-0.appspot.com",messagingSenderId:"473626769958",appId:"1:473626769958:web:1434906be9cb86511284e7",measurementId:"G-X621364E6H"};Bc(tE);const nE=Ny(),cn=qw(),TE=X_();function sE(){let t;if(!cn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=ni(null);return{subscribe:n}}const{subscribe:e}=ni((cn==null?void 0:cn.currentUser)??null,n=>(t=Ov(cn,s=>{n(s)}),()=>t()));return{subscribe:e}}const rE=sE();//! THE ABOVE IS IMPLEMENTED GENERICALLY BELOW
function iE(t){let e;const n=ky(nE,t),{subscribe:s}=ni(null,r=>(e=jy(n,i=>{r(i.data()??null)}),()=>e()));return{subscribe:s,ref:n,id:n.id}}const SE=ld(rE,(t,e)=>{if(t)return iE(`users/${t.uid}`).subscribe(e);e(null)});export{Ke as G,gE as Q,cE as R,yE as W,aE as _,SE as a,vE as b,cn as c,TE as d,nE as e,pE as f,ky as g,EE as h,_E as i,hE as j,lE as k,uE as l,dE as m,mE as n,fE as o,IE as r,wE as s,rE as u};
